...
return [
    ...
    'demo_accounts_help' => 'حساب سوپرادمین همان ایمیلی است که وارد کردید. کاربران آزمایشی آژانس: admin@agency.local / manager@agency.local / dev1@agency.local / viewer@agency.local — رمز همه: password',
    ...
    'seed_demo'          => 'ایجاد داده‌های نمونه (۳ کسب‌وکار + کاربران آزمایشی)',
