...
<div class="kpi-grid kpi-grid-4" style="margin-bottom:20px">
    <div class="kpi-card"><span class="kpi-label"><?= esc(lang('Projects.budget')) ?></span><span class="kpi-value"><?= esc($fmt((float) $project['budget'])) ?></span></div>
    ...
    <?php if ($hasFinance): ?>
    <div class="kpi-card"><span class="kpi-label"><?= esc(lang('Finance.month_expense')) ?></span><span class="kpi-value text-error"><?= esc($fmt($finance['expense'])) ?></span></div>
